...
sidebar_label: Weekly Readings
---

:::caution
This class is subject to change! Please check readings at least the week before
something is due and double-check whether a class is remote or in-person by
monitoring the Microsoft Teams channel.
:::
...
3. Read the [2020 Clio Legal Trends
...
In-class exercise: [Hello, World](classes/docacon-2020/hello-world.md).

For a recording of this in-class exercise for later reference, you can 
view:
...
**If there is time during class**: Start working on the Clio University (16 mini "courses",
CPE01-16). The completed Clio coursework is due by the end of week 5. It
...
* Three CDC Moratorium declaration generators
    * The paper form: https://www.cdc.gov/coronavirus/2019-ncov/communication/EvictionProtectDeclare_508.pdf
    * https://www.covid19evictionforms.com/
    * https://courtformsonline.org/housing/#CDC
    * https://afterpattern.com/cl/kyequaljustice/cdc-eviction-declaration
...
To access Microsoft Flow, go to
